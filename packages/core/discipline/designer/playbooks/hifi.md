...
## Build
- `docs/artifacts/<version>/<slug>.<ext>` — interactive HTML preferred (use the `frontend-design` skill when available). One page per key screen or a linked set; keep candidates collapsed into one page when comparing.
